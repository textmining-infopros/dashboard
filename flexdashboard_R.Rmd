...
#### This storyboard presents the ***results*** of 13 **case studies** performed in the book, **"Text Mining for Information Professionals: An Uncharted Territory"**.

#### To know more about the case studies, and the methodology used to get the results, download the book at SpringerNature. To cite this storyboard use: *©2021 Lamba and Madhusdhan - all rights reserved, unless stated otherwise*.
...
-   Buy the Book from SpringerNature Website

-   [Book Website](https://textmining-infopros.github.io)

-   [Github Repositories of the Chapters Containing the Data, Code and Notebook for the Case Studies](https://github.com/textmining-infopros)
