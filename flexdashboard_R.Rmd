...
This storyboard summaries the visualization for **13 case studies** performed in the book, [**"Text Mining for Information Professionals: An Uncharted Territory"**](https://www.springer.com/in/book/9783030850845). To know more about the case studies, and the methodology used to get the results, download the book from [SpringerNature](https://www.springer.com/in/book/9783030850845). To cite this storyboard use: ***©2021 Lamba and Madhusdhan - all rights reserved*****,** unless stated otherwise.
...
df <- tibble(
 ...
 "http://mybinder.org/v2/gh/textmining-infopros/chapter7/master?urlpath=rstudio", "http://mybinder.org/v2/gh/textmining-infopros/dashboard/master?urlpath=rstudio"),
)
...
![Screenshot of the dashboard summarizing the case studies' results from **Text Mining for Information Professionals: An Uncharted Territory** book (©2021 Lamba and Madhusdhan - all rights reserved)](dashboard.png)
